\section{B. 주차장 정산 시스템}

\begin{frame} % No title at first slide
    \sectiontitle{B}{주차장 정산 시스템}
    \sectionmeta{
        출제자 -- 박준형(\consolas {\href{https://solved.ac/profile/refill447}{@refill447}})\\
        태그: \consolas {\#set, \#hash\_set, \#tree\_set}\\
        예상 난이도 -- \textbf{\color{acS5}Silver5}
    }
    \begin{itemize}
...
\end{frame}
%----------------------------------------------------------------------------
\begin{frame}{\textbf{B}. 주차장 정산 시스템}
    \begin{itemize}
...
\begin{frame}{\textbf{B}. 주차장 정산 시스템}
    ...
    \begin{column}{0.35\textwidth}
        ...
        \includegraphics[width=\linewidth]{images/b-solution-code.png}
    \end{column}
