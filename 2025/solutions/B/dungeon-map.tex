...
\begin{frame} % No title at first slide
    ...
    \sectionmeta{
        출제자 -- 전민주({\consolas @mingmingmon})\\
        {\consolas {\#math, \#arithmetic}}\\
...
\begin{frame}{\textbf{B}. 던전 지도}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.4\linewidth]{images/b-lastrow.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{\textbf{B}. 던전 지도}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.35\linewidth]{images/b-basic.png}
    \end{center}
\end{frame}
...
\begin{frame}{\textbf{B}. 던전 지도}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.5\linewidth]{images/b-proof.png}
    \end{center}
\end{frame}
...
\begin{frame}{\textbf{B}. 던전 지도}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.5\linewidth]{images/b-calc.png}
    \end{center}
\end{frame}
