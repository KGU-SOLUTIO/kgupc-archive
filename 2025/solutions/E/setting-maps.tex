...
\begin{frame} % No title at first slide
    ...
    \sectionmeta{
        \texttt{network\_flow}\\
        출제진 의도 -- \textbf{\color{acP2}Platinum2}
    }
    \begin{itemize}
...
\begin{frame}{\textbf{E}. 지도 설치}
    ...
    \begin{center}
        \includegraphics[width=0.3\linewidth]{images/maps_ex_1.png}
    \end{center}
...
\begin{frame}{\textbf{E}. 지도 설치}
    ...
    \begin{center}
        \includegraphics[width=0.45\linewidth]{images/maps_ex_1.png}
        \hspace{0.05\linewidth}
        \includegraphics[width=0.45\linewidth]{images/maps_sol_1.png}
    \end{center}
...
\begin{frame}{\textbf{E}. 지도 설치}
    ...
    \begin{center}
        \includegraphics[width=0.45\linewidth]{images/maps_sol_1.png}
        \hspace{0.05\linewidth}
        \includegraphics[width=0.45\linewidth]{images/maps_sol_2.png}
    \end{center}
...
\begin{frame}{\textbf{E}. 지도 설치}
    ...
    \begin{center}
        \includegraphics[width=0.30\linewidth]{images/maps_sol_3.png}
    \end{center}
