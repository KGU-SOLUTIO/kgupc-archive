...
\begin{frame} % No title at first slide
    \sectiontitle{D}{컨벤션 대탈출}
    \sectionmeta{
        출제자 -- 전민주(\consolas{\href{https://solved.ac/profile/mingmingmon}{@mingmingmon}})\\
        태그: \consolas {\#bfs, \#grid\_graph}\\
        예상 난이도 -- \textbf{\color{acS2}Silver2}
    }
    \begin{itemize}
...
\begin{frame}{\textbf{D}. 컨벤션 대탈출}
    \begin{itemize}
        ...
        한 좌석에서 다른 좌석으로 이동하는 데 항상 1호 이동한 것이라고 보기 때문에 BFS입니다.\\
